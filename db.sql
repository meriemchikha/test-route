...
VALUES 
('Martinez', 'Julie', '1992-07-12', 'julie.martinez@email.com', 'mdp789', '808 Rue de la Roquette', 'Paris', '75003', 'France', 1, '0123456789'),
('Lemoine', 'Alexandre', '1989-01-25', 'alexandre.lemoine@email.com', 'pass321', '909 Boulevard Montparnasse', 'Lyon', '69003', 'France', 2, '0234 56 78 90'),
('Blanc', 'Camille', '1986-04-30', 'camille.blanc@email.com', 'secure987', '1010 Avenue de la Porte de Clichy', 'Marseille', '13003', 'France', 3, '03 45 67 89 01'),
('Guerin', 'Mathieu', '1995-11-08', 'mathieu.guerin@email.com', 'password654', '111 Rue de la Pompe', 'Toulouse', '31003', 'France', 4, '04 56 78 90 12'),
('Riviere', 'Laura', '1980-09-20', 'laura.riviere@email.com', 'mdp456', '1212 Avenue des Ternes', 'Nice', '06003', 'France', 5, '05 67 89 01 23'),
('Leroux', 'Thomas', '1993-03-15', 'thomas.leroux@email.com', 'pass789', '1313 Boulevard Victor Hugo', 'Paris', '75004', 'France', 6, '06 78 90 12 34'),
('Berger', 'Elodie', '1987-06-02', 'elodie.berger@email.com', 'secure234', '1414 Rue de la Villette', 'Lyon', '69004', 'France', 7, '07 89 01 23 45'),
('Blanchard', 'Hugo', '1990-12-18', 'hugo.blanchard@email.com', 'mdp567', '1515 Avenue de la Bourdonnais', 'Marseille', '13004', 'France', 8, '08 90 12 34 56'),
('Lefevre', 'Caroline', '1984-08-05', 'caroline.lefevre@email.com', 'password123', '1616 Boulevard Pereire', 'Toulouse', '31004', 'France', 9, '09 01 23 45 67'),
('Mercier', 'Nicolas', '1998-02-28', 'nicolas.mercier@email.com', 'secure789', '1717 Rue de la Pompe', 'Nice', '06004', 'France', 10, '10 12 34 56 78'),
('Garcia', 'Sophia', '1987-03-27', 'sophia.garcia@email.com', 'mdp987', '303 Rue de la Bastille', 'Paris', '75002', 'France', 11, '02 34 56 78 90'),
('Roux', 'Antoine', '1991-09-14', 'antoine.roux@email.com', 'pass654', '404 Boulevard Haussmann', 'Lyon', '69002', 'France', 12, '03 45 67 89 01'),
('Fournier', 'Luc', '1983-06-08', 'luc.fournier@email.com', 'password321', '505 Avenue des Gobelins', 'Marseille', '13002', 'France', 13, '04 56 78 90 23'),
('Leclerc', 'Marie', '1998-12-03', 'marie.leclerc@email.com', 'secure789', '606 Rue du Cherche-Midi', 'Toulouse', '31002', 'France', 14, '05 67 89 01 23'),
('Girard', 'Thomas', '1984-05-18', 'thomas.girard@email.com', 'mdp234', '707 Avenue de la Grande Armée', 'Nice', '06002', 'France', 15, '06 78 90 12 34'),
('Dupont', 'Jean', '1990-05-15', 'jean.dupont@email.com', 'mdp123', '123 Rue de la République', 'Paris', '75001', 'France', 16, '01 23 45 67 89'),
('Martin', 'Sophie', '1985-08-22', 'sophie.martin@email.com', 'pass456', '456 Avenue des Champs-Élysées', 'Lyon', '69001', 'France', 17, '04 56 78 90 12'),
('Dubois', 'Pierre', '1992-02-10', 'pierre.dubois@email.com', 'password789', '789 Boulevard Saint-Michel', 'Marseille', '13001', 'France', 18, '06 78 90 12 34'),
('Lefevre', 'Isabelle', '1980-11-30', 'isabelle.lefevre@email.com', 'securepass', '101 Rue du Faubourg Saint-Antoine', 'Toulouse', '31001', 'France', 18, '05 43 21 98 76'),
('Moreau', 'Nicolas', '1995-04-18', 'nicolas.moreau@email.com', 'mdp567', '202 Avenue de la Libération', 'Nice', '06001', 'France', 20, '07 65 43 21 09');
